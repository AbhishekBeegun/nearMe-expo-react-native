...
const SDAbout = () => {
  ...
  return (
    ...
    <Text className="px-8 text-lg font-semibold py-4 text-white">About</Text>
    {ShowMore ? 
          <View className="w-full h-[8vh] overflow-hidden px-4">
           ...
           <View className="w-full h-auto overflow-hidden px-4">
             <Text 
             className="text-white text-xs">{desc}</Text>
           </View>
    }
...
<TouchableOpacity className=' px-8 py-2' 
          onPress={() => handleShowMore()}>
                {ShowMore ? 
                <Text
                className="font-semibold text-white text-xs lg:text-base">Show more</Text>
               :
                <Text
                className="font-semibold text-white py-2 text-xs lg:text-base">Show less</Text>
                }
